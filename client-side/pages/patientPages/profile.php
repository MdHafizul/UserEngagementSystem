                ...
                <div class="modal-body">
                    <form id="editUserForm">
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control border-radius-lg" id="editUserName"
                                placeholder="Enter your name">
                        </div>
                        <div class="mb-4">
                            <label for="editUserEmail" class="form-label fw-semibold">Email</label>
                            <input type="email" class="form-control border-radius-lg" id="editUserEmail"
                                placeholder="Enter your email">
                        </div>
                        <div class="mb-4">
                            <label for="editUserUsername" class="form-label fw-semibold">Username</label>
                            <input type="text" class="form-control border-radius-lg" id="editUserUsername"
                                placeholder="Enter your username">
                        </div>
                        <div class="mb-4">
                            <label for="editUserPassword" class="form-label fw-semibold">Password</label>
                            <input type="password" class="form-control border-radius-lg" id="editUserPassword"
                                placeholder="Enter your password">
                        </div>
                        <button type="submit" class="btn bg-gradient-dark text-black w-100 border-radius-lg">Save
                            Changes</button>
                    </form>
                </div>
            </div>
